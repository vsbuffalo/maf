...
MAFPY=/home/vince251/projects/maf/maf/maf.py

mkdir -p log alns eval time

python $MAFPY map -o mafrun-1.txt -1 $IN1 -2 $IN2 bowtie2.cfg bwa-mem.cfg novoalign.cfg | sed -n "$SLURM_ARRAY_TASK_ID"p | bash
